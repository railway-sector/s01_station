import{wg as X,Hr as Z,Hs as ee,G2 as te,G0 as ie,Ht as re,Hu as ae,G7 as o,Hk as se,GG as oe,Hj as ne,G6 as w,Hv as ce,Hw as le,G3 as pe,G5 as de,G8 as he,H3 as ve,Ga as ue,Hx as A,Hy as F,Hz as me,HA as fe,GK as ge,f$ as Se,Gb as Pe,Gc as ye,_ as _e,Gd as M,Ge as N,Gf as we,Gg as R,Gh as G,GM as ze,Gj as xe,Gk as $e,Gl as be,Gn as V,Go as Te,HB as Ve,HC as E,HD as U,HE as ke,HF as Oe,HG as De,Gp as Ce,n as p,Gq as d,fY as We,GN as Me,HH as I,qR as Ge,Hb as Le,l5 as je,Gv as He,ce as B,yi as Ae,gx as q,cp as Y,HI as Fe}from"./index-CdXucXq0.js";function J(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),P&&(e.include(F),S.constants.add("relativeMarkerSize","float",me/A).constants.add("relativeTipLineWidth","float",fe).code.add(o`
  ...
  `)),e.include(ge,r),e.include(F),S.main.add(o`
    discardBySlice(vpos);
